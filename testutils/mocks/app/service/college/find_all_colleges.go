...
func (_m *FindAllColleges) Handle(ctx context.Context, input *service.FindAllCollegesInput) (*service.PaginationOutput, error) {
	ret := _m.Called(ctx, input)

	var r0 *service.PaginationOutput
	if rf, ok := ret.Get(0).(func(context.Context, *service.FindAllCollegesInput) *service.PaginationOutput); ok {
		r0 = rf(ctx, input)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*service.PaginationOutput)
		}
	}
