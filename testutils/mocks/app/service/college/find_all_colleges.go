...
func (_m *FindAllColleges) Handle(ctx context.Context, input *service.FindAllCollegesInput) (*querying.PaginationOutput[*service.Output], error) {
	ret := _m.Called(ctx, input)

	var r0 *querying.PaginationOutput[*service.Output]
	if rf, ok := ret.Get(0).(func(context.Context, *service.FindAllCollegesInput) *querying.PaginationOutput[*service.Output]); ok {
		r0 = rf(ctx, input)
	} else {
		if ret.Get(0) != nil {
