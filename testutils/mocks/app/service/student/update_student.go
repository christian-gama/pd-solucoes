...
func (_m *UpdateStudent) Handle(ctx context.Context, input *service.UpdateStudentInput) (*service.FindOneStudentOutput, error) {
	ret := _m.Called(ctx, input)

	var r0 *service.FindOneStudentOutput
	if rf, ok := ret.Get(0).(func(context.Context, *service.UpdateStudentInput) *service.FindOneStudentOutput); ok {
		r0 = rf(ctx, input)
	} else {
		if ret.Get(0) != nil {
