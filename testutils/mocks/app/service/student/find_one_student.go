...
func (_m *FindOneStudent) Handle(ctx context.Context, input *service.FindOneStudentInput) (*model.Student, error) {
	ret := _m.Called(ctx, input)

	var r0 *model.Student
	if rf, ok := ret.Get(0).(func(context.Context, *service.FindOneStudentInput) *model.Student); ok {
		r0 = rf(ctx, input)
	} else {
		if ret.Get(0) != nil {
