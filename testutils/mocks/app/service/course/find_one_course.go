...
func (_m *FindOneCourse) Handle(ctx context.Context, input *service.FindOneCourseInput) (*service.FindOneCourseOutput, error) {
	ret := _m.Called(ctx, input)

	var r0 *service.FindOneCourseOutput
	if rf, ok := ret.Get(0).(func(context.Context, *service.FindOneCourseInput) *service.FindOneCourseOutput); ok {
		r0 = rf(ctx, input)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*service.FindOneCourseOutput)
		}
	}
